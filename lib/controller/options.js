...
import { FQuitPlugin, FSwitchModulePlugin, FSwitchTexturePlugin } from '../plugins/index.js';
...
export class UOptionsController {
  ...
  constructor(options) {
    ...
    this._plugins.push(new FSwitchTexturePlugin(),new FSwitchModulePlugin(), new FQuitPlugin());
    // 创建 app 实例
