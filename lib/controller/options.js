...
import { FDragPlugin, FQuitPlugin, FSwitchModulePlugin, FSwitchTexturePlugin } from '../plugins/index.js';
...
export class UOptionsController {
  ...
  constructor(options) {
    ...
    // 安装插件
    this.installPlugin(new FSwitchTexturePlugin, new FSwitchModulePlugin, new FQuitPlugin, new FDragPlugin);
    // init 事件通知
