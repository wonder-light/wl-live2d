...
export class UBaseStageController {
  ...
  init(options) {
    ...
    this.#data.wrapper.className = `${this.#options.fixed ? 'live2d-fixed' : 'live2d-relative'}` +
      ` live2d-wrapper live2d-z-5 live2d-w-min live2d-h-min live2d-left-0 live2d-bottom-0 live2d-touch-none live2d-transition-all live2d-opacity-0 live2d-duration-0`;
  ...
  fadeIn(element = this.wrapper) {
    ...
    element.classList.remove('live2d-opacity-0', 'live2d-duration-0');
