...
export class FHelp {
  ...
  static sayHello() {
    ...
    const format = [
      `background: linear-gradient(to right, #ff00cc, #ffcc00);padding: 8px 30px;font-size: 2em;`,
      `background: linear-gradient(to right, #ff4fa9, #ffa233) text, linear-gradient(to right, #ffcc00, #6fff66, #00ffcc) border-box;color: transparent;padding: 8px 30px;font-size: 2em;`,
      `background: linear-gradient(to right, #00ffcc, #ff00cc);padding: 8px 30px;font-size: 2em;`,
      ``
    ];
